                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 col-mb-12">
                    <div class="widget">
                        ...
                        <ul class="contact-footer">
                            ...
                            <li>
                                <strong>E-mail :</strong><span><a href="#"><span class="__cf_email__"
                                            data-cfemail="3c55525a537c59445d514c5059125f5351">[email&#160;protected]</span></a></span>
                            </li>
                        </ul>
                ...
                <div class="col-md-12">
                    ...
                    <div class="float-right">
                        <ul class="bottom-card">
                            <li>
                                <a href="#"><img src="{{ asset('frontend') }}/img/footer/card1.jpg"
                                        alt="card"></a>
                            </li>
                            <li>
                                <a href="#"><img src="{{ asset('frontend') }}/img/footer/card2.jpg"
                                        alt="card"></a>
                            </li>
                            <li>
                                <a href="#"><img src="{{ asset('frontend') }}/img/footer/card3.jpg"
                                        alt="card"></a>
                            </li>
                            <li>
                                <a href="#"><img src="{{ asset('frontend') }}/img/footer/card4.jpg"
                                        alt="card"></a>
                            </li>
                        </ul>
                    </div>
